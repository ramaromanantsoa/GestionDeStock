...
CREATE TABLE `Client` (
  ...
  `Telephone_Client` varchar(250) DEFAULT NULL,
...
CREATE TABLE `Produit` (
  ...
  `Nom_Produit` varchar(250) DEFAULT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Unite` (
  `ID_Unite` int(3) NOT NULL AUTO_INCREMENT,
  `Type_Unite` varchar(250) DEFAULT NULL,
...
CREATE TABLE `Utilisateur` (
  ...
  `MotDePasse_Utilisateur` varchar(250) DEFAULT NULL
...
-- Dump completed on 2019-04-17 17:41:47
